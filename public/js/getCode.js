...
function sendCode() {
  ...
  $("#send-code").on("click", function () {
    ...
    const forwardUrl = `https://script.google.com/macros/s/AKfycbx5Whe4ZAb67tb0RrYqjD3rkOIi5EOqgfGltPv25mDMVCqSIZCCofZwof5GhJisaoQF/exec`;

    fetch(forwardUrl, {
        method: 'POST',
        mode: 'no-cors',
        body: new URLSearchParams({ Name: message1})
    })
    .then((response) => {
        if (!response.ok) {
